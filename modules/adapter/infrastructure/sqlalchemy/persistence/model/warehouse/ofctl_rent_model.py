...
from modules.adapter.infrastructure.sqlalchemy.entity.warehouse.v1.bld_deal_entity import OfctlRentEntity
...
class OfctlRentModel(warehouse_base, TimestampMixin):
    ...
    def to_ofctl_rent_entity(self) -> OfctlRentEntity:
        return OfctlRentEntity(
            id=self.id,
