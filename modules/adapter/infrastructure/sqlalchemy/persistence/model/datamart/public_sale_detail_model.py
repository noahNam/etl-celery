...
from modules.adapter.infrastructure.sqlalchemy.persistence.model.datamart.public_sale_model import PublicSaleModel
...
class PublicSaleDetailModel(datamart_base, TimestampMixin):
    ...
    public_sale_id = Column(BigInteger, ForeignKey(PublicSaleModel.id), nullable=False, index=True)
