...
class ECRPush:
    ...
    def image_name(self) -> str:
        ...
        if env == "dev":
            return f"toadhome/antgirl-{service_type}-dev"

        if env == "prod":
            return f"toadhome/antgirl-{service_type}-prod"
    ...
    def tag_image(self, image: Image, tag: int, server_address: str) -> None:
