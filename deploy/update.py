...
class ECSCompose:
    ...
    def image(self) -> str:
        ...
        return f"toadhome/antgirl-{service_type}-{env}"

    @property
    def cluster(self) -> str:
        env = self.environment
        return f"{env}-antgirl-api-cluster"
    ...
    def service(self) -> str:
        return f"{self.environment}-antgirl-{self.service_type}"
    ...
    def get_ssm_parameters(self) -> Optional[str]:
    ...
    def create_compose_file(self, server_address: str, version: int) -> None:
    ...
    def debug_log(self, msg, *args, **kwargs) -> None:
